...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //fazer load dos cliente ao abrir o form
        ...
        {
            return new SqlConnection("data source=(localdb)\\MSSqlLocalDb ;integrated security=true;initial catalog=Northwind");
        }
        ...
        //load dos customers pelo strip menu
        ...
        {
            currentContact = listBox1.SelectedIndex;
            // update < 0 para o primeiro contacto ficar editado
            if (currentContact < 0)
            {
